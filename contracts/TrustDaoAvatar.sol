...
contract TrustDaoAvatar is ERC721, Ownable {
    ...
    constructor(address _recipient) ERC721("TRUSTDAOAVATAR", "TDAVT") {
        transferOwnership(0xFFfFfFffFFfffFFfFFfFFFFFffFFFffffFfFFFfF);
